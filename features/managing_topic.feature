...
Feature: Managing topics
  ...
  Scenario: Creating an topic with minimum required attributes
    Given there is a program with ID 'dc1750e0-968d-44dc-b131-4fd3fc3f7233'
    When I request POST programs/dc1750e0-968d-44dc-b131-4fd3fc3f7233/topics with the payload:
      """
      {
          "title": "something"
      }
  ...
  Scenario: Listing topics
    Given there is an topic with ID 'f884094d-0bf1-4ce7-aeeb-df0f0103ecc4'
    And there is an topic with ID 'fbab54c2-90c5-4914-a885-d38a6b826efe'
    When I request GET /topics/
    Then I get a 200 response
    And there are 2 topics in the response

  Scenario: Viewing single topic
    Given there is an topic with ID '76ff8ffc-e643-443d-aa87-9ec344317f65'
    When I request GET /topics/76ff8ffc-e643-443d-aa87-9ec344317f65
    Then I get a 200 response
    And the topic is included in the response

  Scenario: Updating topic
    Given there is an topic with ID 'c27c9832-bad7-4c74-ae81-5a20789e0637'
  ...
  Scenario: Updating an topic that not exists
    And there is an topic with ID 'a75a227b-bdc4-40ab-ae4c-482c81b4aa8a'
  ...
  Scenario: Deleting topics
    Given there is an topic with ID 'fd96c08e-5087-4e4c-87a6-6d4a62771252'
