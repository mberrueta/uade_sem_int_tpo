...
Feature: Managing courses
  ...
  Scenario: Updating course
    Given there is an course with ID '17208a19-eb69-4dec-95fc-baa5be2443a5'
  ...
  Scenario: Updating an course that not exists
    And there is an course with ID 'f6dd2636-d392-419d-a1da-c0e5c8855f00'
  ...
  Scenario: Deleting courses
    Given there is an course with ID '31b3f1be-b6d1-4d86-a6aa-082fafb0685f'
