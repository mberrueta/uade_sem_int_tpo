...
Feature: Managing student answers
  ...
  Scenario: Listing student answers
    Given there is a student answer with ID '0d8983a5-9b72-4800-b7eb-1f67b3ffa236'
    And there is a student answer with ID '1d7471df-fd3c-4daf-a8f7-25a1cd05c9c7'
  ...
  Scenario: Listing student answers by student
    Given there is a student answer with ID '5715d024-b0ed-4f49-a7fd-cf988b9b2227'
    And there is a student exam with ID '8b48a1de-b057-442e-8c73-63198bb9c175'
    And there is a student answer with ID '0cbad0af-f0f7-44ae-8306-9e688f70cdbf'
    And there is a student answer with ID 'd54c0b76-ae84-40b4-a655-1857960c57f5'
  ...
  Scenario: Viewing single student answer
    Given there is a student answer with ID '6f247d1b-ee0d-4f8d-b8ba-2b30ae680254'
    When I request GET /student-answers/6f247d1b-ee0d-4f8d-b8ba-2b30ae680254
    Then I get a 200 response
    And the student answer is included in the response

  Scenario: Updating student_answer
    Given there is a student answer with ID 'cd726100-5822-44b0-8e6c-0edfcc0297af'
  ...
  Scenario: Updating an student answer that not exists
    And there is a student answer with ID 'f6dd2636-d392-419d-a1da-c0e5c8855f00'
  ...
  Scenario: Deleting student_answers
    Given there is a student answer with ID '31b3f1be-b6d1-4d86-a6aa-082fafb0685f'
